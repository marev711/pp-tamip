...
run_folders = [ "TMIP_2009-08-02", "TMIP_2009-08-01", "TMIP_2009-07-31", "TMIP_2009-07-30", 
                "TMIP_2009-07-28", "TMIP_2009-07-27", "TMIP_2009-07-28", "TMIP_2009-07-27", 
                "TMIP_2009-07-30", "TMIP_2009-07-28", "TMIP_2009-07-27", "TMIP_2009-07-26", 
                "TMIP_2009-07-25", "TMIP_2009-07-23", "TMIP_2009-07-22", "TMIP_2009-07-21", 
                "TMIP_2009-07-20", "TMIP_2009-07-18", "TMIP_2009-07-17", "TMIP_2009-07-16", 
                "TMIP_2009-07-15", "TMIP_2009-05-03", "TMIP_2009-05-02", "TMIP_2009-05-01", 
                "TMIP_2009-04-30", "TMIP_2009-04-28", "TMIP_2009-04-27", "TMIP_2009-04-26", 
                "TMIP_2009-04-25", "TMIP_2009-04-23", "TMIP_2009-04-22", "TMIP_2009-04-21", 
                "TMIP_2009-04-20", "TMIP_2009-04-18", "TMIP_2009-04-17", "TMIP_2009-04-16", 
                "TMIP_2009-04-15", "TMIP_2009-02-02", "TMIP_2009-02-01", "TMIP_2009-01-31", 
                "TMIP_2009-01-30", "TMIP_2009-01-28", "TMIP_2009-01-27", "TMIP_2009-01-26", 
                "TMIP_2009-01-25", "TMIP_2009-01-23", "TMIP_2009-01-22", "TMIP_2009-01-21", 
                "TMIP_2009-01-20", "TMIP_2009-01-18", "TMIP_2009-01-17", "TMIP_2009-01-16", 
                "TMIP_2009-01-15", "TMIP_2008-11-02", "TMIP_2008-11-01", "TMIP_2008-10-31", 
                "TMIP_2008-10-30", "TMIP_2008-10-28", "TMIP_2008-10-27", "TMIP_2008-10-26", 
                "TMIP_2008-10-25", "TMIP_2008-10-23", "TMIP_2008-10-22", "TMIP_2008-10-21", 
                "TMIP_2008-10-20", "TMIP_2008-10-18", "TMIP_2008-10-17", "TMIP_2008-10-16", 
                "TMIP_2008-10-15"]
    ...
    for param in params:
        ...
        if (os.path.exists(xml_def_file)):
            ...
            if param_def_file.has_key("write_namelist"):
                ...
                postproc_aux.write_namelist(param_def_file, model_data_folder, def_dir, param)

            if param_def_file.has_key("write_ncl"):
                namelist = param_def_file["write_ncl"].split('\n')
                postproc_aux.write_ncl(param_def_file, model_data_folder, def_dir, param)
